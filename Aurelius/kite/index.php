...
<body>
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="team-member">
								<figure>
									<img src="images/team/team-member-1.png" alt="Team Member">
									<figcaption>
										<p class="member-name">Tetha Valiant</p>
										<p class="designation">
											Project Manager
										</p><!-- /.designation -->
						...
						<div class="col-sm-4">
							<div class="team-member">
								<figure>
									<img src="images/team/team-member-2.png" alt="Team Member">
									<figcaption>
										<p class="member-name">
											Rizza Firmansyah
										</p><!-- /.member-name -->
						...
						<div class="col-sm-4">
							<div class="team-member">
								<figure>
									<img src="images/team/team-member-3.png" alt="Team Member">
									<figcaption>
										<p class="member-name">
											Nikolaus Herjuno
										</p><!-- /.member-name -->
	...
	<section id="subscribe" class="section-style" data-background-image="images/background/newsletter.jpg">
		...
		<footer id="footer-section">
			<p class="copyright">
				&copy; <a href="http://demos.jeweltheme.com/kite">Tiwuk Corp </a>
			</p>
		</footer>
		<!-- Footer Section End -->
